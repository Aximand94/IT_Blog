...
<div class="container">
    <div class="row">
        <h2 style="text-align: center">Изменить категорию постов</h2>
        <form action="../app/control/topics.php" method="POST">
            <input type="hidden" name="id" value="<?=$id;?>">
            <label>Введите новое название категории:</label>
            <div class="input-group mb-3">
                <input type="text" class="form-control" name="topic_name" value="<?=$topic_name;?>">
            </div>
            <label>Описание категории:</label>
            <div class="input-group mb-3">
                <textarea class="form-control" placeholder="Веедите текст" name="topic_description"><?=$topic_description;?></textarea>
            </div>
            <div class="input-group mb-3">
                <input type="reset" class="btn btn-secondary">
                <input type="submit" class="btn btn-primary" name="edit_topic" value="Изменить">
            </div>
        </form>
    </div>
</div>
