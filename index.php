...
<body>
<!-- Header -->
<?php ($_SERVER['DOCUMENT_ROOT'] ."\app\include\header.php");?>
<!-- Slider -->
<div class="container">
    <div class="row">
        <h2 class="slider-title">Главные посты блога</h2>
    </div>
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
         <div class="carousel-inner">
             <div class="carousel-item active">
                 <img src="img/pc_1.jpg" class="d-block w-100" alt="pc">
                 <div class="carousel-caption d-none d-md-block">
                     <h5><a href="#">First slide label</a></h5>
                 </div>
             </div>
             <div class="carousel-item">
                 <img src="img/pc_2.jpg" class="d-block w-100" alt="pc2">
                 <div class="carousel-caption d-none d-md-block">
                     <h5><a href="#">Second slide label</a></h5>
                 </div>
             </div>
             <div class="carousel-item">
                 <img src="img/pc_3.jpg" class="d-block w-100" alt="pc3">
                 <div class="carousel-caption d-none d-md-block">
